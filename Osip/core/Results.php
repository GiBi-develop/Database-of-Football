...
$query = "SELECT * FROM match_of_footbal WHERE 1";
...
else
{
    ...
    echo "<table class=\"simple-little-table\" cellspacing='0' ><tr><th>Id встречи</th><th>Первая команда</th><th>Вторая команда</th><th>Стадион</th><th>Базовая цена</th><th>Дата</th><th>Время</th><th>Забито первой командой</th><th>Забито второй командой</th><th>Статус</th></tr>";
    for($i = 0; $i < $rows ; ++$i)
    {
