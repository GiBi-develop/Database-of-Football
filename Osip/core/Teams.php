...
else
{
    ...
    echo "<table class=\"simple-little-table\" cellspacing='0' ><tr><th>Имя</th><th>Город</th><th>Тренер</th><th>Место в прошлом году</th><th>Победы</th><th>Проигрыши</th><th>Очки</th></tr>";
    for($i = 0; $i < $rows ; ++$i)
    {
